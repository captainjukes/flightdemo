...
$(function(){
	...
	var background2 = new $.gQ.Animation({imageURL: "background6.png"}); 
	var background3 = new $.gQ.Animation({imageURL: "background6.png"});
	var background4 = new $.gQ.Animation({imageURL: "background6.png"});
	var background5 = new $.gQ.Animation({imageURL: "background6.png"});
